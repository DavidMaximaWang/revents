...
const PhotosPage = ({ uploadProfileImage, photos, profile , deletePhoto,setMainPhoto}) => {
  ...
  useEffect(() => {
    return () => {
      files.forEach(file => URL.revokeObjectURL(file.preview)); //revoke the droped url
    };
  });
  const handleSetMainPhoto = async (photo)=>{
    ...
    try{
      ...
      toastr.error('Oops', 'failed to set main photo')
    }
  }
...
)(PhotosPage);// compose can add higher order components, e.g withRouter
